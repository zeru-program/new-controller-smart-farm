...
<body>
    ...
    <main class="m-0">
        <div class="w-100 py-3 d-flex flex-column justify-content-center align-items-center bg-primarys gap-2"
            ...
            <div class="d-flex gap-2">
                <div class="d-flex flex-column p-2 box-sensor position-relative d-flex justify-content-center align-items-center"
                    ...
                    <p class="m-0" id="sublime-temp">Loading..</p>
                ...
                <div
                    ...
                    <p class="m-0" id="sublime-humidity">Loading..</p>
            ...
            <div class="d-flex gap-2">
                <div class="d-flex flex-column p-2 box-sensor position-relative d-flex justify-content-center align-items-center"
                    ...
                    <p class="m-0" id="sublime-moisture1">Loading..</p>
                    <p class="m-0 position-absolute" style="right:10px;top:5px">%</p>
                </div>
                <div class="d-flex flex-column p-2 box-sensor position-relative d-flex justify-content-center align-items-center"
                    ...
                    <p class="m-0" id="sublime-moisture2">Comming soon..</p>
                    <p class="m-0 position-absolute" style="right:10px;top:5px">%</p>
                </div>
            </div>
        </div>
        <div class="container mt-4 d-flex flex-column">
            ...
            <p class="">Controll your farming in here (pastikan server sudah menyala dengan mengklik button 'START
                SERVER' dibawah)</p>
    ...
    <button class="position-fixed justify-content-center align-items-center bg-primarys border-0" id="btn-btn"
        ...
        <div class="m-0 w-100 flex-column justify-content-center text-center align-items-center vh-100 shadow-lg position-fixed py-3"
            id="popup-error-mysql"
            style="display:none;top:0;left:0; background:rgba(225,225,225,.2);backdrop-filter:blur(2px);z-index:999;">
            ...
            <p class="m-0">silakan membuat dan menghubungkan server mysql ke website ini dengan konfigurasi di file
                /config/db.php</p>

            <button class="btn btn-danger position-absolute" onclick="window.location.href = '/'"
                style="left:15px;top:15px;"><i class="bi bi-arrow-left"></i></button>
        </div>
        <!--popup error connect mysql-->
