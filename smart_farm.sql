...
CREATE TABLE `tools_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `relay_pump1` tinyint(1) NOT NULL,
  `relay_fan1` tinyint(1) NOT NULL,
  `datetime` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `tools_data` WRITE;
/*!40000 ALTER TABLE `tools_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `tools_data` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-09-20 10:35:22
