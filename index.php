...
<head>
  ...
  <body>
    ...
    <header class="w-100 hero-home" id="home" style='background: url("assets/bg-hero-home.jpg") fixed no-repeat center center; background-size:cover'>
      <div class="cotainer w-100 vh-100 d-flex flex-column text-center justify-content-center align-items-center">
        ...
        <a href="controller-sf/index.html" class="mt-2">
    ...
    <main class="m-0 w-100 bg-transparent" style="">
      ...
      <div id="about" class="d-flex py-4 position-relative align-items-center text-center text-dark flex-column w-100" style="background:white">
        <img src="assets/team.jpg" style="width:200px" class="mb-3 rounded-3" alt="team" />
        <h1 class="m-0 fw-bold">About us</h1>
        <p class="m-0 container">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure natus nemo ipsam qui iusto, nam voluptate velit deserunt adipisci beatae. Repudiandae necessitatibus doloremque et optio a, iusto placeat sapiente qui.</p>
      </div>
      ...
      <div class="d-flex py-4 gap-3 container justify-content-center  align-items-center text-dark flex-column w-100" style="background:white;">
       ...
       <div class="d-flex" style="border: 1.5px solid #386c5f;width:250px;height:250px;">
         <img src="assets/farmer-ins.jpg" style="z-index:99999;margin-top:10px;margin-left:10px;width:250px;height:250px;object-fit:cover" alt="" class="">
       </div>
       <div class="d-flex flex-column contain-text-why" style="">
         <h1 class="m-0 text-uppercase text-wrap fw-bold font-why-choose-sf">why choose smart farm?</h1>
       </div>
       </div>
       <div class="d-flex mt-2 text-center">
         <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium voluptatum eligendi exercitationem quidem nulla esse nam dolor sunt eaque possimus minima, iusto consequatur neque nisi facere saepe, explicabo qui numquam.</p>
       </div>
       <div class="mt-3 d-flex flex-column align-items-center">
         <h1 class="m-0 fw-bold">Our Circuits</h1>
         <img src="assets/circuits.jpg" style="width:100%" alt="circuits image" class="m-0">
       </div>
      </div>
      <!--about us page editing-->
      ...
      <div id="contact" class="py-4 d-flex flex-column container" style="background:white;">
        <h1 class="m-0 fw-bold text-center">Order our product</h1>
        <p class="m-0 text-center">(smart farm project)</p>
        ...
        <form action="" class="mt-2 d-flex flex-column">
      ...
      <div id="faq" class="py-4 d-flex flex-column container" style="background:white;">
        <h1 class="fw-bold" style="">Frequently Asked Questions</h1>
        <p class="">maybe it's will help you</p>
